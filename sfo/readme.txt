...
3- if data direcory is missing create one, put iran-latest.osm.pbf in directory (uploaded in http://repo.sepahtan.net/repository/gis-data/)
4- put pbf fonts in data directory, like ./data/fonts/{fontname} (uploaded in http://repo.sepahtan.net/repository/gis-data/)
